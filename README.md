...
# ubuntu-iso-builder-remix-pekwm
...
| `+` | `+` |
| [ubuntu-iso-builder-remix-pekwm](https://samwhelp.github.io/ubuntu-iso-builder-remix-pekwm/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-remix-pekwm) |
| `=` | `=` |
| [ubuntu-iso-builder-respin-pekwm](https://samwhelp.github.io/ubuntu-iso-builder-respin-pekwm/) | [GitHub](https://github.com/samwhelp/ubuntu-iso-builder-respin-pekwm) |
...
| Config |
| ------ |
| [~/.config](https://github.com/samwhelp/ubuntu-iso-builder-remix-pekwm/tree/main/profile/template/asset/overlay/etc/skel/.config) |
| [/usr/share/glib-2.0/schemas](https://github.com/samwhelp/ubuntu-iso-builder-remix-pekwm/tree/main/profile/template/asset/overlay/usr/share/glib-2.0/schemas) |
| [/etc/dconf/db/distro.d](https://github.com/samwhelp/ubuntu-iso-builder-remix-pekwm/tree/main/profile/template/asset/overlay/etc/dconf/db/distro.d) |
...
> clone [ubuntu-iso-builder-remix-pekwm](https://github.com/samwhelp/ubuntu-iso-builder-remix-pekwm)

``` sh
git clone https://github.com/samwhelp/ubuntu-iso-builder-remix-pekwm.git
```


> change dir to `ubuntu-iso-builder-remix-pekwm`

``` sh
cd ubuntu-iso-builder-remix-pekwm
```
...
> change dir to `~/work/ubuntu-iso-builder-remix-pekwm/iso-profile`

``` sh
cd ~/work/ubuntu-iso-builder-remix-pekwm/iso-profile
```
...
> The resulting ISO file will be placed on `~/work/ubuntu-iso-builder-remix-pekwm/iso-profile/dist`
